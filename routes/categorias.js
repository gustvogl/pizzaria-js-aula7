...
// '../' volta uma pasta (sai da pasta /routes)
...
//
// Resposta esperada:
//   [ { "id": 1, "nome": "Pizzas Salgadas" }, { "id": 2, "nome": "Bebidas" }, ... ]
router.get('/', (req, res) => {
...
//   { "id": 4, "nome": "Bordas Recheadas" }
router.post('/', (req, res) => {
    // Criamos um novo objeto de categoria.
    // Usamos Math.max para pegar o maior ID existente e somar 1.
    // Isso é mais seguro do que db.categorias.length + 1!
    const novaCategoria = {
