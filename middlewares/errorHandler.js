// =============================================================
// middlewares/errorHandler.js — Middleware de Tratamento de Erros da Pizzaria
// =============================================================
// O que é este Middleware?
//   Um "plano B" (ou extintor de incêndio) para quando algo dá errado na API.
...
//   poderia travar completamente (crash) e a pizzaria fecharia as portas!
//
// Como funciona?
...
//   Assim ele captura erros de qualquer parte (qualquer rota) da aplicação.
//
// Fluxo visual de erro:
//   Rota da Pizza com erro → [Error Handler Middleware] → JSON de erro → Cliente / App
// =============================================================
...
const errorHandlerMiddleware = (err, req, res, next) => {
    ...
    // Loga o erro no terminal do servidor para o DESENVOLVEDOR (ou Pizzaiolo) ver.
    // Isso não aparece para o usuário final, só no seu VS Code / Terminal!
    ...
    //   - Um objeto JSON com informações amigáveis do erro
    res.status(500).json({
        sucesso: false,
        ...
        // para o usuário (pode revelar informações sensíveis do banco de dados/servidor).
        // Aqui mandamos o detalhe apenas para fins DIDÁTICOS, para ver na tela de teste!
        detalhe: err.message
    });
};

// ─── Exportação ───────────────────────────────────────────────
// Exportamos para importar no server.js como 'errorHandler'
